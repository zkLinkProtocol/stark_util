...
impl From<ProviderArgs> for ExtendedProvider {
    fn from(args: ProviderArgs) -> Self {
        ...
        match args {
            ProviderArgs::Rpc(url) => ExtendedProvider::new(
                AnyProvider::JsonRpcHttp(JsonRpcClient::new(HttpTransport::new(url))),
                is_integration,
            ),
                    ...
                    None => match network {
                        ...
                        Network::Integration => {
                            ...
                            SequencerGatewayProvider::new(
                                Url::parse("https://external.integration.starknet.io/gateway")
                                    .unwrap(),
                                Url::parse(
